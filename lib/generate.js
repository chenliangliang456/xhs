...
const { normalizeImageBaseUrl, wrapNetworkError } = require('./apiUrlNormalize');

const API_BASE_URL = () =>
  normalizeImageBaseUrl(process.env.API_BASE_URL || '');
...
async function apiFetch(path, options = {}) {
  ...
  try {
    ...
    throw wrapNetworkError(err, `生图服务 ${API_BASE_URL() || ''}`.trim());
  }
